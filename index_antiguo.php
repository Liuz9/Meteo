<html>
  <head>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmsI__ZGRKNWyhcNC2AFXVyjHaRIfOZ0E&signed_in=true&callback=initMap&libraries=geometry"></script>
